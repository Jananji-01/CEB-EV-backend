...
//
//@CrossOrigin(origins = "http://localhost:8082", allowedHeaders = "*", allowCredentials = "true")
//@RestController
...
//                    new ApiResponse(true, "Login successful", token, roles, user.getUsername(), user.getEAccountNumber())
//            );
//
...
//    }
//
//    // ... Verify-OTP and Logout methods can remain as they were
//
//    // Optional resend OTP
