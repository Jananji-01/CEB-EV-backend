...
//            }
//
//            // 3️⃣ Fetch status from database
//            Optional<IdTagInfo> tagOpt = idTagInfoRepository.findByIdTag(idTag); // just find by idTag
//            String status = tagOpt.map(IdTagInfo::getStatus).orElse("Invalid");
//
//            // 4️⃣ Return only STATUS
