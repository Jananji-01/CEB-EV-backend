...
public class OcppMessageProcessor {
    ...
    private ObjectNode handleBootNotification(String deviceId, JsonNode payload) {
        ...
        try {
            ...
            response.put("currentTime", ZonedDateTime.now(ZoneOffset.UTC).plusHours(5).plusMinutes(30).toString());
...
private ObjectNode handleStartTransaction(String deviceId, String messageId, JsonNode payload) {
    ...
    try {
        ...
        List<IdTagInfo> tagOpt = idTagInfoRepository.findByIdTag(idTag);
    ...
    private ObjectNode handleStopTransaction(String deviceId, JsonNode payload) {
        ...
        try {
            ...
            transactionDetails.put("timestamp", LocalDateTime.now(ZoneOffset.UTC).plusHours(5).plusMinutes(30).toString());
    ...
    private void logMessage(String deviceId, String messageId, String action,
        ...
        try {
            ...
            log.setReceivedAt(LocalDateTime.now(ZoneOffset.UTC).plusHours(5).plusMinutes(30));
